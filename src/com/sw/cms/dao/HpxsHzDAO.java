...
public class HpxsHzDAO extends JdbcBaseDAO {
	...
	public List getHpxshzTjResult(String product_kind,String product_name,String product_xh,
		...
		String sql = "select a.product_id,b.sp_txm,b.product_name,b.product_xh,sum(a.nums) as nums,sum(a.hjje) as hjje from product_sale_flow a left join product b on b.product_id=a.product_id left join clients c on c.id=a.client_name where 1=1";
	...
	public List getHpxsmlhzTjResult(String product_kind,String product_name,String product_xh,
		...
		String sql = "select a.product_id,b.sp_txm,b.product_name,b.product_xh,b.prop,sum(a.nums) as nums,sum(a.hjje) as hjje,sum(a.cb) as hjcb,sum(a.ygcb) as hjygcb,sum(a.bhsje) as bhsje from product_sale_flow a left join product b on b.product_id=a.product_id where 1=1";
