...
public class EmployeeDAO extends JdbcBaseDAO {
	...
	public Page getYwyEmployee(String con, int curPage, int rowPerPage) {
		String sql = "select a.*,b.dept_name from sys_user a left join dept b on b.dept_id=a.dept where a.is_sys_user=0 and a.is_ywy='��' and a.is_del='0'";
		if (!con.equals("")) {
			sql = sql + con;
		}
	...
	public int getEmployeeByNameIsExist(String employeeName) {
		String sql = "select count(*) as name from sys_user where is_sys_user=0 and is_ywy='��' and is_del='0' and real_name='"
				+ employeeName + "'";
