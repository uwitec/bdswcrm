...
public class CgfkHzReportDAO extends JdbcBaseDAO {
	...
	public List getCgfkMxList(String start_date,String end_date,String client_name,String jsr,String isYfk,String account_id){
		String sql = "select a.id,DATE_FORMAT(a.cz_date,'%Y-%m-%d') as fk_date,a.fkzh,a.jsr,a.fkje,a.remark,a.is_yfk,b.name as client_name from cgfk a left join clients b on b.id=a.gysbh where state='已支付'";
