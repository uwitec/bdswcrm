...
public class DeptDAO extends JdbcBaseDAO {
	...
	private String getDeptId(String parent_id) {
		...
		String rtId = "";
		String sql = "select max(dept_id) as id from dept where parent_id='" + ID + "'";
	...
	class DeptRowMapper implements RowMapper {
		public Object mapRow(ResultSet rs, int index) throws SQLException {
			...
			if(SqlUtil.columnIsExist(rs,"dept_id")) dept.setDept_id(rs.getString("dept_id"));
			if(SqlUtil.columnIsExist(rs,"dept_name")) dept.setDept_name(rs.getString("dept_name"));
			if(SqlUtil.columnIsExist(rs,"fzr")) dept.setFzr(rs.getString("fzr"));
			if(SqlUtil.columnIsExist(rs,"phone")) dept.setPhone(rs.getString("phone"));
			if(SqlUtil.columnIsExist(rs,"xh")) dept.setXh(rs.getInt("xh"));
			if(SqlUtil.columnIsExist(rs,"parent_id")) dept.setParent_id(rs.getString("parent_id"));
