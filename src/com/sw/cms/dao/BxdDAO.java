...
public class BxdDAO extends JdbcBaseDAO 
{
  ...
  public Object getBxdProduct(String bxd_id)
  {
	  ...
	  return this.getJdbcTemplate().queryForObject(sql, new BxdProductRowMapper());
  }
  ...
  class BxdRowMapper implements RowMapper 
  {
		...
		{
			Bxd bxd = new Bxd(); 
			if(SqlUtil.columnIsExist(rs,"id"))bxd.setId(rs.getString("id"));
			if(SqlUtil.columnIsExist(rs,"jxdate"))bxd.setJxdate(rs.getString("jxdate"));
			if(SqlUtil.columnIsExist(rs, "cjdate"))bxd.setCjdate(rs.getString("cjdate"));
			if(SqlUtil.columnIsExist(rs, "jddate"))bxd.setJddate(rs.getString("jddate"));
			if(SqlUtil.columnIsExist(rs, "jxr"))bxd.setJxr (rs.getString("jxr"));
			if(SqlUtil.columnIsExist(rs, "cjr"))bxd.setCjr(rs.getString("cjr"));
			if(SqlUtil.columnIsExist(rs, "gcs"))bxd.setGcs(rs.getString("gcs"));
			if(SqlUtil.columnIsExist(rs, "state"))bxd.setState(rs.getString("state"));
			if(SqlUtil.columnIsExist(rs, "client_name"))bxd.setClient_name(rs.getString("client_name"));
			if(SqlUtil.columnIsExist(rs, "lxr"))bxd.setLxr(rs.getString("lxr"));
			if(SqlUtil.columnIsExist(rs, "lxdh"))bxd.setLxdh(rs.getString("lxdh"));
			if(SqlUtil.columnIsExist(rs, "email"))bxd.setEmail(rs.getString("email"));
			if(SqlUtil.columnIsExist(rs, "address"))bxd.setAddress(rs.getString("address"));
			if(SqlUtil.columnIsExist(rs, "cz"))bxd.setCz(rs.getString("cz"));
			if(SqlUtil.columnIsExist(rs, "yb"))bxd.setYb(rs.getString("yb"));
			if(SqlUtil.columnIsExist(rs, "remark"))bxd.setRemark(rs.getString("remark"));	
			return bxd;
		}
  }
  /**
  ...
  class BxdProductRowMapper implements RowMapper {
		public Object mapRow(ResultSet rs, int index) throws SQLException 
		{
			...
			if(SqlUtil.columnIsExist(rs, "id"))bxdProduct.setId(rs.getInt("id"));
			if(SqlUtil.columnIsExist(rs, "bxd_id"))bxdProduct.setBxd_id(rs.getString("bxd_id"));
			if(SqlUtil.columnIsExist(rs, "product_name"))bxdProduct.setProduct_name(rs.getString("product_name"));
			if(SqlUtil.columnIsExist(rs, "product_id"))bxdProduct.setProduct_id(rs.getString("product_id"));
			if(SqlUtil.columnIsExist(rs, "product_gg"))bxdProduct.setProduct_gg(rs.getString("product_gg"));
			if(SqlUtil.columnIsExist(rs, "product_xh"))bxdProduct.setProduct_xh(rs.getString("product_xh"));
			if(SqlUtil.columnIsExist(rs, "product_serial_num"))bxdProduct.setProduct_serial_num(rs.getString("product_serial_num"));
			if(SqlUtil.columnIsExist(rs, "product_remark"))bxdProduct.setProduct_remark(rs.getString("product_remark"));
			if(SqlUtil.columnIsExist(rs, "bxaddress"))bxdProduct.setBxaddress(rs.getString("bxaddress"));
			if(SqlUtil.columnIsExist(rs, "bxstate"))bxdProduct.setBxstate(rs.getString("bxstate"));
			if(SqlUtil.columnIsExist(rs, "has_fj"))bxdProduct.setHas_fj(rs.getString("has_fj"));
			if(SqlUtil.columnIsExist(rs, "fj"))bxdProduct.setFj(rs.getString("fj"));
			if(SqlUtil.columnIsExist(rs, "qtfj"))bxdProduct.setQtfj(rs.getString("qtfj"));
			if(SqlUtil.columnIsExist(rs, "bj"))bxdProduct.setBj(rs.getString("bj"));
			if(SqlUtil.columnIsExist(rs, "gzfx"))bxdProduct.setGzfx(rs.getString("gzfx"));
			if(SqlUtil.columnIsExist(rs, "pcgc"))bxdProduct.setPcgc(rs.getString("pcgc"));
			if(SqlUtil.columnIsExist(rs, "gf"))bxdProduct.setGf(rs.getDouble("gf"));
			return bxdProduct;
		}
  }
