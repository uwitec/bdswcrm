...
public class CbtzDAO extends JdbcBaseDAO {
	 ...
	 * @param kh_cbj
	 */
	public void updateProduct(String id,String dj_type,double kh_cbj,double lsxj,double gf,double ds){
		String sql = "";
		if(dj_type.equals("xs")){
			sql = "update xsd_product set kh_cbj=" + kh_cbj + ",lsxj=" + lsxj + ",gf=" + gf + ",ds=" + ds + " where id='" + id + "'";
		}else{
			sql = "update lsd_product set kh_cbj=" + kh_cbj + ",lsxj=" + lsxj + ",gf=" + gf + ",ds=" + ds + " where id='" + id + "'";
		}
