...
var contentPanel = new Ext.TabPanel({
	...
	items:[{
		...
		title:'首页',
		autoScroll:true,
		html:'<iframe scrolling="no" name="pageIndex" id="pageIndex" frameborder="0" width="100%" height="100%" src="listFxMain.html"></iframe>'
	}]
});
		...
		children:[
				{
					...
					children:[{
									id:"fc_对账单",
							    	text:"对账单",leaf:true,expanded:true,
					           		listeners:{
										'click':function(node, event) {
											...
											if (!n) { //判断是否已经打开该面板
												n = contentPanel.add({
													...
													html:'<iframe scrolling="no" frameborder="0" width="100%" height="100%" src="showDlsDzdCondition.html"></iframe>'
												});
											}
...
var topNav = new Ext.Panel({
		...
		margins:'0 0 0 0',
		autoScroll:false,
		html:'<iframe scrolling="no" frameborder="0" width="100%" height="100%" src="dls_index_top.html"></iframe>'
	});
