...
//具有审批权限的角色
String cqspRoles = (String)VS.findValue("cqspRoles");
...
<head>
<title>超期审批权限设定</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<link href="css/css.css" rel="stylesheet" type="text/css" />
</head>
<body>
<form name="myform" action="saveCqSpRightRoles.html" method="post">
<table width="100%"  align="center"  class="chart_list" cellpadding="0" cellspacing="0">
	<tr>
		<td class="csstitle" align="left" width="75%">&nbsp;&nbsp;&nbsp;&nbsp;<b>设定超期审批角色</b>
		</td>		
	</tr>	
</table>
<center>
...
<table width="100%"  align="center"  class="chart_list" cellpadding="0" cellspacing="0">
	...
	while(it.hasNext()){
		...
		if(cqspRoles.indexOf(role_id) != -1){
			flag = "checked";
		}
	%>
	<tr>
...
说明：超期审批权限与角色关联，选择具有超期审批权限的角色，点击何“保存”按钮即可。
</body>
</html>
