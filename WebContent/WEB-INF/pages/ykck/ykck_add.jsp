...
<script type="text/javascript">
    ...
    function addTr(){
        var otr = document.getElementById("ykckTable").insertRow(-1);
...
<form name="YkckForm" action="saveYkck.html" method="post">
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a2"  width="35%"><input type="text" name="ykck.ck_date" id="ck_date" value="<%=DateComFunc.getToday() %>" size="45" class="Wdate" onFocus="WdatePicker()"><font color="red">*</font>
		</td>	
	</tr>
	<tr>			
