...
<table width="100%"  align="center"  class="chart_list" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td class="search" align="left" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;
			日期：<input type="text" name="creatdate1" value="<%=creatdate1 %>" size="10" readonly>	
...
<table width="100%"  align="center"  class="chart_list" cellpadding="0" cellspacing="0" border="1" id="selTable">
	...
	<tr>
		...
		<td onclick="doSort('store_id');">库房名称<%if(orderName.equals("store_id")) out.print("<img src='images/" + orderType + ".gif'>"); %></td>
...
<form name="descForm" action="descDbsq.html" method="post" target="desc">
