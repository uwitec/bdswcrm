...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a1">报废日期</td>
		<td class="a2"><input type="text" name="bfd.bf_date" id="bf_date" value="<%=DateComFunc.getToday() %>" readonly>
		</td>		
	</tr>
	<tr>		 
...
<%
 ...
 %>
	<tr>
				...
				<td class="a2"><input type="text" id="nums_<%=i %>" name="bfdProducts[<%=i %>].nums" value="<%=bfdProduct.getNums() %>" size="5" onblur="setNum(<%=i %>)"  style="width:90%" readonly></td>		 
				<td class="a2">	
				...
				<td class="a2">
			        ...
			        <input type="hidden" id="qz_flag_<%=i %>" name="bfdProducts[<%=i %>].qz_flag" value="<%=flag2 %>"><a style="cursor:hand" title="左键点击输入序列号" onclick="openSerialWin('<%=i %>');"><b>...</b></a>&nbsp;
				</td>			
	...
	for(int i=0;i<3;i++)
	{
		%>
			<tr>
			    <td class="a2"><input type="checkbox" name="proc_id" id="proc_id" value="<%=i %>"></td>
				<td class="a2">
					<input type="text" id="product_name_<%=i %>" name="bfdProducts[<%=i %>].product_name" style="width:90%"  >
					<input type="hidden" id="product_id_<%=i %>" name="bfdProducts[<%=i %>].product_id">
				</td>
				<td class="a2"><input type="text" id="product_xh_<%=i %>" name="bfdProducts[<%=i %>].product_xh" size="13" style="width:90%" ></td>	
				<td class="a2"><input type="text" id="nums_<%=i %>" name="bfdProducts[<%=i %>].nums" value="1" size="5" onblur="setNum(<%=i %>)" ></td>		 
				<td class="a2">					
					<input type="text" id="store_id" name="store_id" value="坏件库" size="7" readonly>				 
				</td>
				<td class="a2">
			        <input type="text" id="qz_serial_num_<%=i %>" name="bfdProducts[<%=i %>].qz_serial_num"  size="10" readonly>
			        <input type="hidden" id="qz_flag_<%=i %>" name="bfdProducts[<%=i %>].qz_flag"> <a style="cursor:hand" title="左键点击输入序列号" onclick="openSerialWin('<%=i %>');"><b>...</b></a>&nbsp;
				</td>		
				<td class="a2"><input type="text" id="product_remark_<%=i %>" name="bfdProducts[<%=i %>].product_remark"  style="width:90%"></td>				
			</tr>
		<%
	}
}
