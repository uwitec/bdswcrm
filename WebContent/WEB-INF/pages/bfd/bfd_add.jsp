...
<%
 ...
 %>
	<tr>
				...
				<td class="a2"><input type="text" id="nums_<%=i %>" name="bfdProducts[<%=i %>].nums" value="<%=bfdProduct.getNums() %>" size="5" onblur="setNum(<%=i %>)"  style="width:100%" readonly></td>		 
				<td class="a2">	
	...
	for(int i=0;i<3;i++)
	{
		%>
			<tr>
			    <td class="a2"><input type="checkbox" name="proc_id" id="proc_id" value="<%=i %>"></td>
				<td class="a2">
					<input type="text" id="product_name_<%=i %>" name="bfdProducts[<%=i %>].product_name" style="width:100%"  >
					<input type="hidden" id="product_id_<%=i %>" name="bfdProducts[<%=i %>].product_id">
				</td>
				<td class="a2"><input type="text" id="product_xh_<%=i %>" name="bfdProducts[<%=i %>].product_xh" size="13" style="width:100%" ></td>	
				...
				<td class="a2"><input type="text" id="product_remark_<%=i %>" name="bfdProducts[<%=i %>].product_remark"  style="width:100%"></td>				
			</tr>
		<%
	}
}
