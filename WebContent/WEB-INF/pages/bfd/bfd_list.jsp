...
<form name="descForm" action="descBfd.html" method="post" target="bfddesc">
	<input type="hidden" name="id" value="">
</form>
<table width="100%"  align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td><iframe id="bfddesc" name="bfddesc" onload="dyniframesize('bfddesc');" width="100%" border="0" frameborder="0" SCROLLING="no"  src=''/></td>
	</tr>
</table>
