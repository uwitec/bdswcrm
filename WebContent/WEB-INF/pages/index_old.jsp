...
<TABLE cellSpacing=0 cellPadding=0 width="100%" height="100%" background="" border=0>
	...
	<TR vAlign=top height="60">
		<TD colspan=3><IFRAME id=FrameTop style="WIDTH: 100%; height:100%; POSITION: relative" border=0  src="thk_main_top.html?flag=1" frameBorder=0 scrolling=no></IFRAME></TD>
	<TR>
	<!-- 头结束 -->	
