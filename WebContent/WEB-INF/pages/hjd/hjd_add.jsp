...
<script type="text/javascript">
    ...
    function addTr(){
       ...
       // var curId = ($('xsdtable').rows.length-2);
		...
		otd7.className = "a2";
		otd7.innerHTML = '<input type="text" id="nqz_serial_num_'+curId+'" name="hjdProducts['+curId+'].nqz_serial_num" size="15" readonly><input type="hidden" id="qz_flag_'+curId+'" name="hjdProducts['+curId+'].qz_flag"><a style="cursor:hand" title="点击输入序列号" onclick="openSerialWin('+ curId +');"><b>...</b></a>&nbsp;';           
...
<form name="HjdForm" action="saveHjd.html" method="post">
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a1">日期</td>
		<td class="a2"><input type="text" name="hjd.hj_date" id="hj_date" value="<%=DateComFunc.getToday() %>"  class="Wdate" onFocus="WdatePicker()"><font color="red">*</font>
		</td>	
	</tr>
	<tr>			
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">	
	...
	<tr>
		...
		<td class="a2" width="85%">
			<textarea rows="6" name="hjd.remark" id="remark" style="width:75%" maxlength="500"></textarea>
		</td>
	</tr>	
	<tr height="35">
