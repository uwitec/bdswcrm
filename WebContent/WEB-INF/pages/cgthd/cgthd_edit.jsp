...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a2">
		<input type="text" name="cgthd.id" id="id" value="<%=StringUtils.nullToStr(cgthd.getId()) %>" size="30" maxlength="50" readonly>
		</td>	
		<td class="a1">退货日期</td>
		<td class="a2"><input type="text" name="cgthd.th_date" id="th_date" value="<%=StringUtils.nullToStr(cgthd.getTh_date()) %>" readonly>
	...
	<tr>			
		...
		<td class="a2">
		<input type="text" name="cgthd.provider_id" id="client_name" value="<%=StaticParamDo.getClientNameById(StringUtils.nullToStr(cgthd.getProvider_name())) %>" size="30" maxlength="50" readonly>
		...
		<td class="a2" width="35%">
			...
			%>
				<option value="<%=strid %>" <%if(StringUtils.nullToStr(cgthd.getJsr()).equals(strid)) out.print("selected"); %>><%=name %></option>
			<%
				}
			}
			%>
...
<table width="100%"  align="center" class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a1">合计金额</td>
		<td class="a2"><input type="text" id="tkzje"  name="cgthd.tkzje" value="<%=JMath.round(cgthd.getTkzje()) %>" readonly></td>
	</tr>		
</table>
<br>
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">	
	...
	<tr>
		...
		<td class="a2" width="85%">
			<textarea rows="3" name="cgthd.remark" id="remark" style="width:75%" maxlength="500"><%=StringUtils.nullToStr(cgthd.getRemark()) %></textarea>
		</td>
	</tr>	
	<tr height="35">
