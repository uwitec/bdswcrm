...
%>		
	<tr>
		...
		<td class="a1">退货日期</td>
		<td class="a2"><input type="text" name="cgthd.th_date" id="th_date" value="<%=StringUtils.nullToStr(cgthd.getTh_date()) %>"  class="Wdate" onFocus="WdatePicker()"><font color="red">*</font>
		</td>	
	</tr>
	<tr>			
