...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a2" width="35%"><input type="text" name="follow.lxdate" id="lxdate" readonly="readonly" value="<%if(null!=follow.getLxdate()){out.print(StringUtils.nullToStr(follow.getLxdate().substring(0,10)));} %>">
		...
		<td class="a2" width="35%"><input type="text" name="follow.nextdate" id="nextdate" readonly="readonly" value="<%if(null!=follow.getNextdate()){out.print(StringUtils.nullToStr(follow.getNextdate().substring(0,10)));} %>">
