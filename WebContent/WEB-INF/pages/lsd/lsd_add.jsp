...
<script type="text/javascript">
    ...
    function addTr(){
        ...
        otd0.className = "a2";
        otd0.innerHTML = '<input type="text" id="product_name_'+curId+'" name="lsdProducts['+curId+'].product_name" style="width:90%" readonly><input type="hidden" id="product_id_'+curId+'" name="lsdProducts['+curId+'].product_id">';
        
        var otd1 = document.createElement("td");
        otd1.className = "a2";
        otd1.innerHTML = '<input type="text" id="product_xh_'+curId+'"  name="lsdProducts['+curId+'].product_xh" size="15" style="width:90%" readonly>';

        var otd3 = document.createElement("td");
        otd3.className = "a2";
        otd3.innerHTML = '<input type="text" id="price_'+curId+'" name="lsdProducts['+curId+'].price" value="0.00" size="7" style="width:90%;text-align:right;" onblur="hj();"><input type="hidden" id="cbj_'+curId+'" name="lsdProducts['+curId+'].cbj" value="0.00"><input type="hidden" id="kh_cbj_'+curId+'" name="lsdProducts['+curId+'].kh_cbj" value="0.00"><input type="hidden" id="gf_'+curId+'" name="lsdProducts['+curId+'].gf" value="0">';      
        
        
        var otd5 = document.createElement("td");
        otd5.className = "a2";
        otd5.innerHTML = '<input type="text" id="nums_'+curId+'" name="lsdProducts['+curId+'].nums" value="0" size="5" style="width:90%;text-align:center;" onblur="hj();">';
        
        var otd8 = document.createElement("td");
        otd8.className = "a2";
        otd8.innerHTML = '<input type="text" id="xj_'+curId+'" name="lsdProducts['+curId+'].xj" value="0.00" size="7" style="width:90%;text-align:right;" readonly>';        
        
        var otd9 = document.createElement("td");
        otd9.className = "a2";
        otd9.innerHTML = '<input type="text" id="qz_serial_num_'+curId+'" name="lsdProducts['+curId+'].qz_serial_num" size="15" readonly onclick="openSerialWin('+ curId +');"><input type="hidden" id="qz_flag_'+curId+'" name="lsdProducts['+curId+'].qz_flag"><a style="cursor:hand" title="点击输入序列号" onclick="openSerialWin('+ curId +');"><b>...</b></a>&nbsp;';   
...
<body onload="initFzrTip();chgKpTyle('<%=StringUtils.nullToStr(lsd.getFplx()) %>');submitSp();showMsg();">
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		%>
		<td class="a1">销售日期</td>
		<td class="a2"><input type="text" name="lsd.creatdate" id="creatdate" value="<%=rq %>" style="width:232px" readonly />
		</td>		
	</tr>
	<tr>
		...
		<td class="a2">
			...
			<span id="spanHykId" style="display: none;"><input type="text" name="lsd.hyk_id" id="hyk_id" value=""  size="24"  title="输入会员卡号" onblur="getHydainfo();"/> <font color="red">*</font></span>
		</td>
	...
	<tr>
		...
		<td class="a2" colspan="3">         
			<input id="brand" type="text" mzxlength="20"  style="width:232px" onblur="setValue()" value="<%=StaticParamDo.getRealNameById(lsd.getXsry()) %>"/> 
...
%>
	<tr>
		...
		<td class="a2">
			<input type="text" id="product_name_<%=i %>" name="lsdProducts[<%=i %>].product_name" value="<%=StringUtils.nullToStr(lsdProduct.getProduct_name()) %>" style="width:90%" readonly>
			<input type="hidden" id="product_id_<%=i %>" name="lsdProducts[<%=i %>].product_id" value="<%=StringUtils.nullToStr(lsdProduct.getProduct_id()) %>">
		</td>
		<td class="a2"><input type="text" id="product_xh_<%=i %>" name="lsdProducts[<%=i %>].product_xh" size="15" value="<%=StringUtils.nullToStr(lsdProduct.getProduct_xh()) %>" style="width:90%" readonly></td>	
		<td class="a2">
			<input type="text" id="price_<%=i %>" name="lsdProducts[<%=i %>].price" value="<%=JMath.round(lsdProduct.getPrice()) %>" size="7" style="width:90%" onblur="hj();">
		...
		<td class="a2"><input type="text" id="nums_<%=i %>" name="lsdProducts[<%=i %>].nums" value="<%=lsdProduct.getNums() %>" size="5" style="width:90%" onblur="hj();"></td>
		<td class="a2"><input type="text" id="xj_<%=i %>" name="lsdProducts[<%=i %>].xj" value="<%=JMath.round(lsdProduct.getXj()) %>" size="7" style="width:90%" readonly></td>
		<td class="a2">
	...
	for(int i=0;i<3;i++){
		%>
			<tr>
				<td class="a2"><input type="checkbox" name="proc_id" id="proc_id" value="<%=i %>"></td>
				<td class="a2">
					<input type="text" id="product_name_<%=i %>" name="lsdProducts[<%=i %>].product_name" style="width:90%" readonly>
					<input type="hidden" id="product_id_<%=i %>" name="lsdProducts[<%=i %>].product_id">
				</td>
				<td class="a2"><input type="text" id="product_xh_<%=i %>" name="lsdProducts[<%=i %>].product_xh" size="15" style="width:90%" readonly></td>	
				<td class="a2">
					<input type="text" id="price_<%=i %>" name="lsdProducts[<%=i %>].price" value="0.00" size="7" style="width:90%;text-align: right;" onblur="hj();">
				...
				<td class="a2"><input type="text" id="nums_<%=i %>" name="lsdProducts[<%=i %>].nums" value="0" size="5" style="width:90%;text-align: center;" onblur="hj();"></td>
				<td class="a2"><input type="text" id="xj_<%=i %>" name="lsdProducts[<%=i %>].xj" value="0.00" size="7" style="width:90%;text-align: right;" readonly></td>
				<td class="a2">
					<input type="text" id="qz_serial_num_<%=i %>" name="lsdProducts[<%=i %>].qz_serial_num" size="15" readonly onclick="openSerialWin('<%=i %>');">
...
<table width="100%"  align="center" class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>	
		<td class="a1">合计金额</td>
		<td class="a2" colspan="3">
			<input type="text" name="lsd.lsdje" id="lsdje" value="<%=JMath.round(lsd.getLsdje()) %>" style="width:232px" readonly>
	...
	<tr>
		...
		<td class="a2" width="35%">
			<input type="text" name="lsd.skje" id="skje" value="<%=JMath.round(lsd.getSkje()) %>" style="width:232px" readonly>
		</td>	
	...
	<tr id="ysStyle" style="<%=cssStyle %>">	
		...
		<td class="a2">
			<input type="text" name="lsd.yushk_id" id="yushk_id" value="<%=StringUtils.nullToStr(lsd.getYushk_id()) %>" style="width:232px" onclick="openYushk();" readonly>
			<input type="button" name="btnSel" value="选择" class="css_button" onclick="openYushk();">
		</td>
		<td class="a1">预收金额</td>
		<td class="a2">
			<input type="text" name="lsd.yushkje" id="yushkje" value="<%=JMath.round(lsd.getYushkje()) %>" style="width:232px" readonly>
		</td>		
	</tr>		
	<tr>
		...
		<td class="a1">收款账户</td>
		<td class="a2"><input type="text" id="zhname"  name="zhname" value="<%=StaticParamDo.getAccountNameById(StringUtils.nullToStr(lsd.getSkzh())) %>" onclick="openAccount();" readonly style="width:232px">
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">	
	...
	<tr>
		...
		<td class="a2" width="35%"><input type="text" name="lsd.lxr" id="lxr" value="<%=StringUtils.nullToStr(lsd.getLxr()) %>" maxleng="20" style="width:232px"></td>	
	</tr>
	<tr>
		<td class="a1" width="15%">联系电话</td>
		<td class="a2"><input type="text" name="lsd.lxdh" id="lxdh" value="<%=StringUtils.nullToStr(lsd.getLxdh()) %>" maxlength="20" style="width:232px"></td>	
		<td class="a1" width="15%">手机</td>
		<td class="a2"><input type="text" name="lsd.mobile" id="mobile" value="<%=StringUtils.nullToStr(lsd.getMobile()) %>" maxlength="20" style="width:232px"></td>			
	</tr>
	<tr>
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">	
	...
	<tr>
		...
		<td class="a2" id="dz2" style="display:none"><input type="text" name="lsd.kp_address" id="kp_address" value="<%=StringUtils.nullToStr(lsd.getKp_address()) %>" style="width:232px" maxlength="50"></td>	
