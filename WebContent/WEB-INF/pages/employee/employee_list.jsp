...
<script type="text/javascript">	
	function view(id){
		...
		var fea ='width=800,height=660,left=' + (screen.availWidth-800)/2 + ',top=' + (screen.availHeight-850)/2 + ',directories=no,localtion=no,menubar=no,status=no,toolbar=no,scrollbars=yes,resizeable=no';
