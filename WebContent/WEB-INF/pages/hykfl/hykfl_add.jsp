...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a2" width="80%" colspan="3"><input type="text" name="hykfl.id" id="id" value="<%=id %>" size="45" readonly><font color="red">*</font></td>
	</tr>
	<tr>
		<td class="a1" width="15%">名称</td>
		<td class="a2" colspan="3">
			<input type="text" id="name" name="hykfl.name"  value="" size="45"><font color="red">*</font>
		</td>
	</tr>
	<tr>
