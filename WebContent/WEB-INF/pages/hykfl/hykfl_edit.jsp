...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a2" width="75%" colspan="3"><input type="text" name="hykfl.id" id="id" value="<%=StringUtils.nullToStr(hykfl.getId()) %>" style="width:180px" readonly><font color="red">*</font></td>
	</tr>
	
	<tr>
		<td class="a1">名称</td>
		<td class="a2">
			<input type="text" id="name" name="hykfl.name"  value="<%=StringUtils.nullToStr(hykfl.getName()) %>" style="width:180px" maxlength="25" notNull='true' vdisp='名称'  vtype='string'><font color="red">*</font>
		</td>
	</tr>
	<tr>
