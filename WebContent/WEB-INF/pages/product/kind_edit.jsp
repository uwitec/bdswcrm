...
<script type="text/javascript">
	function saveInfo(){
		if(!InputValid(document.myform.kindName,1,"string",1,1,25,"产品类别名称")){	 return; }
		if(!InputValid(document.myform.ms,0,"string",0,1,500,"产品类别描述")){	 return; }
