...
<script type="text/javascript">	  
    ...
    function addTr(){
        ...
        otd0.className = "a2";
        otd0.innerHTML = '<input type="text" id="product_name_'+curId+'" name="fhkhdProducts['+curId+'].product_name" style="width:90%" readonly><input type="hidden" id="product_id_'+curId+'" name="lsdProducts['+curId+'].product_id">';
        ...
        otd4.className = "a2";
        otd4.innerHTML = '<input type="text" id="store_id_'+curId+'" name="fhkhdProducts['+curId+'].store_id" value="坏件库" size="7" style="width:90%"  readonly>';
        
        var otd5 = document.createElement("td");
        otd5.className = "a2";
        otd5.innerHTML = '<input type="text" id="price_'+curId+'" name="fhkhdProducts['+curId+'].price" value="0.00" size="5" style="width:90%" readonly>';
        
        var otd7 = document.createElement("td");
        otd7.className = "a2";
        otd7.innerHTML = '<input type="text" id="nums_'+curId+'" name="fhkhdProducts['+curId+'].nums" value="0" size="5" style="width:90%" readonly onblur="setNum('+curId+')">';
        
        var otd8 = document.createElement("td");
        otd8.className = "a2";
        otd8.innerHTML = '<input type="text" id="xj_'+curId+'" name="fhkhdProducts['+curId+'].xj" value="0.00" size="5" style="width:90%" readonly>';
        ...
        otd11.className = "a2";
        otd11.innerHTML = '<input type="text" id="cpfj_'+curId+'"  name="fhkhdProducts['+curId+'].cpfj" size="15"  style="width:90%" readonly>';

        var otd6 = document.createElement("td");
        otd6.className = "a2";
        otd6.innerHTML = '<input type="text" id="remark_'+curId+'" name="fhkhdProducts['+curId+'].remark" style="width:90%"  readonly>';                       
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>			
		...
		<td class="a2" width="35%">		 
			...
			<input type="text" name="fhkhd.linkmanLs" id="linkmanLs" value="<%=StringUtils.nullToStr(fhkhd.getLxr()) %>" style="width:232px;display: none">
		</td>			
	</tr>
	<tr>
