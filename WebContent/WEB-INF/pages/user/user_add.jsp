...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a2" width="35%"><input type="text" name="user.user_name" id="user_name" value="<%=StringUtils.nullToStr(user.getUser_name()) %>"><font color="red">*</font></td>
	...
	<tr>
		...
		<td class="a2" width="35%"><input type="password" name="user.password" id="password" value="<%=StringUtils.nullToStr(user.getPassword()) %>"><font color="red">*</font></td>
		<td class="a1" width="15%">密码确认</td>
		<td class="a2" width="35%"><input type="password" name="user.password2" id="password2" value="<%=StringUtils.nullToStr(user.getPassword()) %>"><font color="red">*</font></td>		
	</tr>	
	<tr>
...
<div id="div_gys" style="display:none">
	<input type="text" name="kind_name" id="kind_name" value="" readonly>
