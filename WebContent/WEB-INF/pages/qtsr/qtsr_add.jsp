...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a2" width="35%"><input type="text" name="qtsr.id" id="id" value="<%=id %>" readonly></td>
		<td class="a1" width="15%">收入日期</td>
		<td class="a2">
			<input type="text" name="qtsr.sr_date" id="sr_date" value="<%=DateComFunc.getToday() %>" readonly>
	...
	<tr>
		...
		<td class="a2" width="35%"><input type="text" name="qtsr.skje" id="skje" value=""></td>		
	</tr>	
	<tr>
		<td class="a1" width="15%">收款账号</td>
		<td class="a2" width="35%"><input type="text" id="zhname"  name="zhname" value="" readonly>
		<input type="hidden" id="skzh"  name="qtsr.skzh" value="">
		...
		<td class="a2">
         ...
         <img src="images/select.gif" align="absmiddle" title="选择经手人" border="0" onclick="openywyWin();" style="cursor:hand">
          <div   id="brandTip"  style="height:12px;position:absolute;left:385px; top:110px; width:132px;border:1px solid menu;background-Color:#fff;display:none;" >
		    ...
		    <input type="hidden" name="qtsr.jsr" id="jsr"  /> 
		<!--修改 --------------------------------------------------------------------------------------  -->
		</td>		
	</tr>
	<tr>
