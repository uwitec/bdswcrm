...
<script type="text/javascript">
	...
	function sel(product_id,product_xh,product_name,serial_num,client_name,linkman,lxdh,address,remark){
		...
		var product_serial_num = window.opener.document.getElementById("oqz_serial_num_<%=openerId%>");
		...
		var product_remark = window.opener.document.getElementById("product_remark_<%=openerId%>");
		 
		if(id != null) id.value = product_id;
		if(xh != null) xh.value = product_xh;
		if(name != null) name.value = product_name;
		if(product_serial_num != null) product_serial_num.value = serial_num;
		if(product_remark != null) product_remark.value = remark;
...
<form name="myform" action="selShkcByzy.html" method="post">
<input type="hidden" name="openerId" value="<%=openerId %>">
<table width="100%"  align="center"class="chart_list" cellpadding="0" cellspacing="0">
	<tr>
		<td class="csstitle" align="left" width="100%">&nbsp;&nbsp;&nbsp;&nbsp;<b>选择在外件库商品列表</b></td>			
	</tr>
	<tr>
