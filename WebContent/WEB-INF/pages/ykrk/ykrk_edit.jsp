	...
	<tr>			
		...
		<td class="a2" colspan="3">
			<select name="ykrk.state" id="state">
				<option value="已保存"  <%if(StringUtils.nullToStr(ykrk.getState()).equals("已保存")) out.print("selected"); %>>已保存</option>
				<option value="已提交" <%if(StringUtils.nullToStr(ykrk.getState()).equals("已提交")) out.print("selected"); %>>已提交</option>
			</select>			
		</td>			
	</tr>
</table>
