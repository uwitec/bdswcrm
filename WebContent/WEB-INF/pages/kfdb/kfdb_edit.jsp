...
%>	
	<tr>
		...
		%>
		<td class="a1">日期</td>
		<td class="a2"><input type="text" name="kfdb.ck_date" id="ck_date" value="<%=date %>" style="width:230px" class="Wdate" onFocus="WdatePicker()">
		<font color="red">*</font>	
		</td>	
	</tr>
	<tr>			
	...
	<tr>
		...
		<td class="a2" width="35%"><input type="text" name="kfdb.dbsq_id" id="dbsq_id" value="<%=StringUtils.nullToStr(kfdb.getDbsq_id()) %>" style="width:230px" maxlength="20"></td>
...
%>
	<tr>
		...
		<td class="a2">
			<input type="text" id="product_name_<%=i %>" name="kfdbProducts[<%=i %>].product_name" value="<%=StringUtils.nullToStr(kfdbProduct.get("product_name")) %>" style="width:100%" readonly>
			<input type="hidden" id="product_id_<%=i %>" name="kfdbProducts[<%=i %>].product_id" value="<%=StringUtils.nullToStr(kfdbProduct.get("product_id")) %>">
		</td>
		<td class="a2"><input type="text" id="product_xh_<%=i %>" name="kfdbProducts[<%=i %>].product_xh" value="<%=StringUtils.nullToStr(kfdbProduct.get("product_xh")) %>" style="width:100%" readonly></td>
		<td class="a2"><input type="text" id="nums_<%=i %>" name="kfdbProducts[<%=i %>].nums"  value="<%=StringUtils.nullToStr(kfdbProduct.get("nums")) %>" style="width:100%"></td>
		<td class="a2">
...
%>
	<tr>
		...
		<td class="a2"><input type="text" id="nums_<%=i %>" name="kfdbProducts[<%=i %>].nums" value="0" style="width:100%"></td>
		<td class="a2">
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">	
	...
	<tr>
		...
		<td class="a2" width="85%">
			<textarea rows="4" name="kfdb.remark" id="remark" style="width:75%" maxlength="500"></textarea>
		</td>
	</tr>	
	<tr height="35">
