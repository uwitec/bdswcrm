...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a2" width="35%">
			...
			%>
				<option value="<%=id %>" <%if(StringUtils.nullToStr(kfdb.getSqr()).equals(id)) out.print("selected"); %>><%=name %></option>
			<%
				}
			}
			%>
		...
		<td class="a2" width="35%">
			...
			if(userList != null){
				...
				while(it.hasNext()){
					...
					String name = StringUtils.nullToStr(map.get("real_name"));
			%>
				<option value="<%=id %>" <%if(StringUtils.nullToStr(kfdb.getJsr()).equals(id)) out.print("selected"); %>><%=name %></option>
			<%
				}
			}
			%>
