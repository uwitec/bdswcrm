...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0" id="tables">
	...
	<tr>
		...
		<td class="a2"><%=StringUtils.nullToStr(wxrkd.getWx_date())%> 
		</td>
	</tr>
	<tr>
		...
		<td class="a2">
		   <%=StaticParamDo.getRealNameById(wxrkd.getWxr()) %>		    
		</td>	
...
<table width="100%"  align="center" id="lsdtable"  class="chart_list" cellpadding="0" cellspacing="0">	
	...
	<tr>
		<td class="a2">
			 <%=StringUtils.nullToStr(wxrkdProduct.getProduct_name()) %> 
			 
		</td>
		<td class="a2">
			 <%=StringUtils.nullToStr(wxrkdProduct.getProduct_xh()) %> 
		</td>
		...
		<td class="a2">
			 <%=StringUtils.nullToStr(wxrkdProduct.getQz_serial_num()) %> 
		</td>	
			
		<td class="a2">
		   <%=StringUtils.nullToStr(wxrkdProduct.getRemark()) %> 
		</td>
	</tr>
</table>
...
<table width="100%"  align="center" class="chart_info" cellpadding="0" cellspacing="0">	
	<tr height="35">
		...
		<td class="a2" colspan="3">
			<textarea rows="2" name="wxrkdProduct.gzfx" id="gzfx" style="width:75%" readonly="readonly"><%=StringUtils.nullToStr(wxrkdProduct.getGzfx()) %> </textarea>
		</td>	
	</tr>	
	<tr height="35">
		 <td class="a1" width="15%">排除过程</td>
		<td class="a2" colspan="3">
			<textarea rows="2" name="wxrkdProduct.pcgc" id="pcgc" style="width:75%" readonly="readonly"><%=StringUtils.nullToStr(wxrkdProduct.getPcgc()) %> </textarea>
		</td>	
	</tr>	 
</table>
<br>
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">	
	...
	<tr>
		...
		<td class="a2" width="35%"> <%=StaticParamDo.getClientNameById(wxrkd.getClient_name()) %> 
		 
		</td>
		<td class="a1" width="15%">联系人</td>
		<td class="a2" width="35%"> <%=StringUtils.nullToStr(wxrkd.getLxr()) %> </td>	
	</tr>
	<tr>
		<td class="a1" width="15%">联系电话</td>
		<td class="a2"> <%=StringUtils.nullToStr(wxrkd.getMobile()) %> </td>	
		<td class="a1" width="15%">地址</td>
		<td class="a2" colspan="3"> <%=StringUtils.nullToStr(wxrkd.getAddress()) %> </td>					
	</tr>
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">	
	...
	<tr>
		...
		<td class="a2" width="85%" colspan="3">
			<textarea rows="2" name="wxrkd.ms" id="ms" style="width:75%" readonly="readonly"><%=StringUtils.nullToStr(wxrkd.getMs()) %> </textarea>
		</td>
	</tr>			
	<tr height="35">
