...
<table width="100%"  align="center"  class="chart_list" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td class="search" align="left" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;			
			日期：<input type="text" name="tj_date1" value="<%=tj_date1 %>" size="10" readonly>	
			<img src="images/data.gif" style="cursor:hand" width="16" height="16" border="0" onClick="return fPopUpCalendarDlg(document.myform.tj_date1); return false;">
			&nbsp;&nbsp;&nbsp;至&nbsp;&nbsp;&nbsp;
			<input type="text" name="tj_date2" value="<%=tj_date2 %>" size="10" readonly>	
			<img src="images/data.gif" style="cursor:hand" width="16" height="16" border="0" onClick="return fPopUpCalendarDlg(document.myform.tj_date2); return false;">			
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		
...
<table width="100%"  align="center"  class="chart_list" cellpadding="0" cellspacing="0" border="1" id="selTable">
	...
	<tr>
		...
		<td onclick="doSort('tj_date');">日期<%if(orderName.equals("tj_date")) out.print("<img src='images/" + orderType + ".gif'>"); %></td>
...
<form name="descForm" action="descChtj.html" method="post" target="desc">
