...
<script type="text/javascript">
	function saveInfo(){
		document.getElementById("content").value = eWebEditor1.eWebEditor.document.body.innerHTML;
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td class="a1" width="20%">公告内容</td>
		<td class="a2" colspan="3">
			<textarea name="xxfbNbgg.content" id="content" rows="1" style="width:90%" style="display:none"><%=StringUtils.nullToStr(xxfbNbgg.getContent()) %></textarea>
