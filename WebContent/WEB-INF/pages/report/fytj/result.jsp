...
String ywy = StringUtils.nullToStr(request.getParameter("ywy"));        //业务员编号
...
if(!ywy.equals("")){
	strCon += "&nbsp;&nbsp;<b>业务员：</b>" + StaticParamDo.getRealNameById(ywy);
}

if(!fy_type.equals("")){
	strCon += "&nbsp;&nbsp;<b>费用类型：</b>" + fy_type;
}
%>
...
%>	
		<TR>
			...
			<TD class=ReportItemXh><%=ywy_name %>&nbsp;</TD>
