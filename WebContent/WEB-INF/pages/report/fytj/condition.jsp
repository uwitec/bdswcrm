	...
	<tr>
		...
		<td class="a4">
         ...
         <img src="images/select.gif" align="absmiddle" title="选择经手人" border="0" onclick="openywyWin();" style="cursor:hand">
          <div   id="brandTip"  style="height:12px;position:absolute;left:660px; top:85px; width:132px;border:1px solid #CCCCCC;background-Color:#fff;display:none;" >
          </div>
		    <input type="hidden" name="ywy" id="ywy"  /> 
		<!--修改 --------------------------------------------------------------------------------------  -->
		</td>					
	</tr>
	<tr>
...
function setValue()
{
  if(document.getElementById("brand").value!="")
  {
    ...
    if(brand in lists)
    {
      document.getElementById("ywy").value=lists[brand];
    ...
    else
    {
      ...
      document.getElementById("ywy").value="";
