...
<TABLE  align="center" cellSpacing=0 cellPadding=0 width="99%" border=0>
	<TBODY>
		<TR style="BACKGROUND-COLOR: #dcdcdc;height:45;">
		    <TD align="center" width="100%"><font style="FONT-SIZE: 16px"><B>业务员应收汇总</B></font><br><%=con %></TD>
		</TR>
	</TBODY>
</TABLE>
...
<TABLE align="center" class="stripe" cellSpacing=0 cellPadding=0 width="99%" border=0 style="BORDER-TOP: #000000 2px solid;BORDER-LEFT:#000000 1px solid">
	<THEAD>
		<TR>
			<TD class=ReportHead width="20%">业务员</TD>
			<TD class=ReportHead width="20%">期初数</TD>
			<TD class=ReportHead width="20%">本期发生数</TD>
			<TD class=ReportHead width="20%">本期收款</TD>
			<TD class=ReportHead width="20%">当前应收款</TD>
		</TR>
	</THEAD>
