...
<form name="refreshForm" action="getHpflMxResult.html" method="post">
...
<TABLE  align="center" cellSpacing=0 cellPadding=0 width="99%" border=0>
	<TBODY>
		<TR style="BACKGROUND-COLOR: #dcdcdc;height:45;">
		    <TD align="center" width="100%"><font style="FONT-SIZE: 16px"><B>货品销售分类汇总--明细</B></font><br><%=con %></TD>
		    <TD align="center">
