...
<body  >
<form name="reportForm" action="getXsskHzResult.html" method="post">
	...
	<tr>
		...
		<td class="a4">
         ...
         <img src="images/select.gif" align="absmiddle" title="选择经手人" border="0" onclick="openywyWin();" style="cursor:hand">
          <div   id="brandTip"  style="height:12px;position:absolute;left:685px; top:85px; width:132px;border:1px solid #CCCCCC;background-Color:#fff;display:none;" >
          </div>
		    <input type="hidden" name="jsr" id="jsr"  /> 
		<!--修改 --------------------------------------------------------------------------------------  -->
		</td>		
	</tr>
	<tr>
		...
		<td class="a1">包括预收</td>
		<td class="a4">
			<input type="radio" name="isYsk" id="isYsk" value="1" checked> 是
			<input type="radio" name="isYsk" id="isYsk" value="2"> 否
		</td>
	</tr>		
	<tr height="35">
