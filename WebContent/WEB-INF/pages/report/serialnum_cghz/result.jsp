...
<TABLE  align="center" cellSpacing=0 cellPadding=0 width="99%" border=0>
	<TBODY>
		<TR style="BACKGROUND-COLOR: #dcdcdc;height:45px;">
		    <TD align="center" width="100%"><font style="FONT-SIZE: 16px"><B>商品序列号采购汇总</B></font><br><%=strCon %></TD>
		</TR>
	</TBODY>
</TABLE>
<BR>
<TABLE align="center" class="stripe" cellSpacing=0 cellPadding=0 width="99%" border=0 style="BORDER-TOP: #000000 2px solid;BORDER-LEFT:#000000 1px solid">
	<THEAD>
		<TR>
			...
			<TD class=ReportHead width="13%">供应商名称</TD>	
			<TD class=ReportHead width="12%">供应商电话</TD>	
			<TD class=ReportHead width="7%">采购员</TD>			
		</TR>
	</THEAD>
...
%>	
		<TR>
			...
			<TD class=ReportItem><%=StringUtils.nullToStr(map.get("gzdh")) %>&nbsp;</TD>
...
<input type="hidden" name="action" value="exportProductSerialCgHzResult">
