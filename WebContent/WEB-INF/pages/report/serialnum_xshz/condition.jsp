	...
	<tr>	
		...
		<td class="a4" colspan="3">
         ...
         <img src="images/select.gif" align="absmiddle" title="选择经手人" border="0" onclick="openywyWin();" style="cursor:hand">
          <div   id="brandTip"  style="height:12px;position:absolute;left:120px; top:116px; width:132px;border:1px solid menu;background-Color:#fff;display:none;" >
          </div>
		    <input type="hidden" name="xsry_name" id="xsry_name"  /> 
		<!--修改 --------------------------------------------------------------------------------------  -->
		</td>					
	</tr>
	<tr height="35">
...
function setValue()
{
  if(document.getElementById("brand").value!="")
  {
    ...
    if(brand in lists)
    {
      document.getElementById("xsry_name").value=lists[brand];
    ...
    else
    {
      ...
      document.getElementById("xsry_name").value="";
