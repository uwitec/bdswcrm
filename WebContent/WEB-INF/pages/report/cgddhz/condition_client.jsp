...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0" border="0" id="selTable">
	<tr>
		...
		<td class="a4" width="35%">
			<input type="text" name="start_date" id="start_date" style="width:232px" size="30" value="<%=DateComFunc.getToday() %>"  class="Wdate" onFocus="WdatePicker()"></td>
		<td class="a1" width="15%">结束日期</td>
		<td class="a4" width="35%">
			<input type="text" name="end_date" id="end_date" style="width:232px" size="30" value="<%=DateComFunc.getToday() %>"  class="Wdate" onFocus="WdatePicker()"></td>
	</tr>
	<tr>
		<td class="a1">单据编号</td>
		<td class="a4">
			<input type="text" name="dj_id" id="dj_id" value=""  style="width:232px"size="30">
		</td>
		<td class="a1">供应商名称</td>
		<td class="a4">
			<input type="text" name="client_name" style="width:232px" id="client_name" value="" onblur="setClientValue();"  size="30"  maxlength="50">
