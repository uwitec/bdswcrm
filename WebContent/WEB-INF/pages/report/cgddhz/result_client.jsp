...
<script type="text/javascript">
	function openWin(dj_id,start_date,end_date,client_name){
		...
		location.href = "getClientcgddMxCondition.html?dj_id=" + dj_id + "&start_date=" + start_date + "&end_date=" + end_date + "&client_name=" + client_name;
	}
</script>
</head>
<body align="center" >
...
<TABLE align="center" cellSpacing=0 cellPadding=0 width="99%" border=0 style="BORDER-TOP: #000000 2px solid;BORDER-LEFT:#000000 1px solid">
	<THEAD>
		<TR>
			...
			<TD class=ReportHead>未入库金额</TD>
			<TD class=ReportHead>已入库金额</TD>	
		</TR>
	</THEAD>
	<TBODY>
<%
...
double jeNext=0;
List list = cgddhzService.getClientCgList(start_date, end_date, dj_id, client_name);
