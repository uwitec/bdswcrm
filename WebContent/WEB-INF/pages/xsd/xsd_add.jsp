...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a2">
         ...
         <img src="images/select.gif" align="absmiddle" title="选择经手人" border="0" onclick="openywyWin();" style="cursor:hand">
          <div   id="brandTip"  style="height:12px;position:absolute;left:610px; top:55px; width:132px;border:1px solid menu;background-Color:#fff;display:none;" >
          </div>
	...
	<tr>	
		...
		<td class="a2">
		<input type="text" name="xsd.client_id" id="client_name" value="<%=StaticParamDo.getClientNameById(StringUtils.nullToStr(xsd.getClient_name())) %>" size="30" maxlength="50" readonly>
