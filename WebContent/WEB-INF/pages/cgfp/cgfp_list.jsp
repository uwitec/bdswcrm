...
<script type="text/javascript">
	...
	function openWinRk(id){
		var destination = "viewCgfpRk.html?id="+id;
		var fea = 'width=850,height=600,left=' + (screen.availWidth-850)/2 + ',top=' + (screen.availHeight-720)/2 + ',directories=no,localtion=no,menubar=no,status=no,toolbar=no,scrollbars=yes,resizeable=no';
...
<table width="100%"  align="center"  class="chart_list" cellpadding="0" cellspacing="0" border="1" id="selTable">
	<thead>
	<tr>		
	    <td onclick="doSort('gysmc');">供货单位<%if(orderName.equals("gysmc")) out.print("<img src='images/" + orderType + ".gif'>"); %></td>
		<td onclick="doSort('cgnums');">单据数<%if(orderName.equals("cgnums")) out.print("<img src='images/" + orderType + ".gif'>"); %></td>
		<td onclick="doSort('cgmoney');">总金额<%if(orderName.equals("cgmoney")) out.print("<img src='images/" + orderType + ".gif'>"); %></td>
	...
	<% 
	   ...
	   {
	%> 
	<tr class="a1" title="双击查看详情"  onmousedown="trSelectChangeCss()" onDblClick="openWinRk('<%=StringUtils.nullToStr(map.get("gysbh")) %>');">
	<%  
	   }
	%>
		...
		<td>
		  ...
		  <%}
		     ...
		     {
		      %>
		      	<a href="#" onclick="openWinRk('<%=StringUtils.nullToStr(map.get("gysbh")) %>');"><img src="images/view.gif" align="absmiddle" title="查看" border="0" style="cursor:hand"></a>&nbsp;&nbsp;&nbsp;&nbsp;
		    <%} %>
		</td>
	</tr>
