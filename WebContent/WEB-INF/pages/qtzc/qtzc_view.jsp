...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a2" width="35%" colspan="3"><%=StringUtils.nullToStr(qtzc.getState()) %></td>		
	</tr>
</table>
<BR>
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr height="50">
		...
		<td class="a2" colspan="3">
			<textarea rows="4" cols="50" name="qtzc.remark" id="remark" style="width:80%" maxlength="500" readonly><%=StringUtils.nullToStr(qtzc.getRemark()) %></textarea>
		</td>
	</tr>
	<tr height="35">
