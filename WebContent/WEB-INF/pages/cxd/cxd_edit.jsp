...
<script type="text/javascript">
	...
	var allCount = parseInt(strCount);
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a2" width="35%">
			...
			<ww:textfield name="cxd.qz_flag" id="qz_flag" value="%{cxd.qz_flag}" theme="simple"  readonly="true"/>
		</td>						
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="a2">
			<ww:select name="cxd.state" id="state" theme="simple" list="#{'已保存':'已保存','已提交':'已提交'}"  emptyOption="false" ></ww:select>
		</td>				
	</tr>
	<tr>
