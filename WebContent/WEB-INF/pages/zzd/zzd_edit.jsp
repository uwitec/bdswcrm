...
<script type="text/javascript">
    ...
    function addTr(){
        ...
        otd1.className = "a2";
        otd1.innerHTML = '<input type="text" name="zzdProducts[' + curId + '].product_name" value="" readonly="readonly" id="product_name_' + curId + '" style="width:90%"/><input type="hidden" name="zzdProducts[' + curId + '].product_id" value="" id="product_id_' + curId + '"/>';
       
        var otd2 = document.createElement("td");
        otd2.className = "a2";
        otd2.innerHTML = '<input type="text" name="zzdProducts[' + curId + '].product_xh" value="" readonly="readonly" id="product_xh_' + curId + '" style="width:90%"/>';
        
        
        var otd3 = document.createElement("td");
        otd3.className = "a2";
        otd3.innerHTML = '<input type="text" name="zzdProducts[' + curId + '].product_dw" value="" readonly="readonly" id="product_dw_' + curId + '" style="width:90%"/>';    
        
        var otd4 = document.createElement("td");
        otd4.className = "a2";
        otd4.innerHTML = '<input type="text" name="zzdProducts[' + curId + '].price" value="0.00" onblur="hj();" id="price_' + curId + '" readonly="true" style="width:90%;text-align:right"/>';               
        
        var otd5 = document.createElement("td");
        otd5.className = "a2";
        otd5.innerHTML = '<input type="text" name="zzdProducts[' + curId + '].nums" value="0" onblur="hj();" id="nums_' + curId + '" style="width:90%;text-align:center"/>';                       

        var otd6 = document.createElement("td");
        otd6.className = "a2";
        otd6.innerHTML = '<input type="text" name="zzdProducts[' + curId + '].hj" value="0.00" readonly="readonly" id="hj_' + curId + '" style="width:90%;;text-align:right"/>';    
        
        var otd7 = document.createElement("td");
        otd7.className = "a2";
        otd7.innerHTML = '<input type="text" name="zzdProducts[' + curId + '].qz_serial_num" value="" id="qz_serial_num_' + curId + '" style="width:80%" onclick="openSerialWin(' + curId + ');" readonly/> <input type="hidden" id="qz_flag_' + curId + '" name="zzdProducts[' + curId + '].qz_flag" value=""><a style="cursor:hand" title="左键点击输入输列号" onclick="openSerialWin(' + curId + ');"><b>...</b></a>';            

        var otd8 = document.createElement("td");
        otd8.className = "a2";
        otd8.innerHTML = '<input type="text" name="zzdProducts[' + curId + '].remark" value="" id="remark_' + curId + '" style="width:90%"/>';
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="a2" width="35%">
			<ww:textfield name="zzd.id" id="id" value="%{zzd.id}" cssStyle="width:232px" theme="simple" readonly="true"/><span style="color:red">*</span>
		</td>
		<td class="a1" width="15%">单据日期</td>
		<td class="a2" width="35%">
			<input type="text" name="zzd.cdate" id="cdate" style="width:232px" value="<ww:property value="%{zzd.cdate}"/>" class="Wdate" onFocus="WdatePicker()"/>&nbsp;	
	...
	<tr>
		...
		<td class="a2" width="35%">
			<ww:textfield name="zzd.product_name" id="product_name" cssStyle="width:232px" value="%{zzd.product_name}" theme="simple" maxLength="100"  size="30" readonly="true"/>
		...
		<td class="a2" width="35%">
			<ww:textfield name="zzd.product_id" id="product_id" cssStyle="width:232px" value="%{zzd.product_id}" theme="simple"  readonly="true"/>
	...
	<tr>
		...
		<td class="a2" width="35%">
			<ww:textfield name="zzd.product_xh" id="product_xh" cssStyle="width:232px" value="%{zzd.product_xh}" theme="simple"  size="30" readonly="true"/>
		</td>
		<td class="a1" width="15%">单位</td>
		<td class="a2" width="35%">
			<ww:textfield name="zzd.product_dw" id="product_dw" cssStyle="width:232px" value="%{zzd.product_dw}" theme="simple" readonly="true"/>
		</td>						
	</tr>
	<tr>
		<td class="a1" width="15%">单价</td>
		<td class="a2" width="35%">
			<ww:textfield id="price" name="zzd.price" cssStyle="width:232px" value="%{getText('global.format.double',{zzd.price})}" theme="simple"/>
		</td>
		<td class="a1" width="15%">数量</td>
		<td class="a2">
			<ww:textfield id="nums"  name="zzd.nums" cssStyle="width:232px" value="%{zzd.nums}" theme="simple" onblur="hjf();"/><span style="color:red">*</span>
		</td>						
	</tr>
	<tr>
		<td class="a1" width="15%">金额</td>
		<td class="a2" width="35%">
			<ww:textfield id="hjje" name="zzd.hjje" cssStyle="width:232px" value="%{getText('global.format.double',{zzd.hjje})}" theme="simple" readonly="true"/>
		</td>
		<td class="a1" width="15%">经手人</td>
		<td class="a2">
			<ww:textfield name="brand" id="brand" cssStyle="width:232px" onblur="setValue()" value="%{getUserRealName(zzd.jsr)}" theme="simple"></ww:textfield>
	...
	<tr>
		...
		<td class="a2">
			<ww:select name="zzd.store_id" id="store_id" cssStyle="width:232px" theme="simple" list="%{storeList}" listValue="name" listKey="id" emptyOption="true"></ww:select><span style="color:red">*</span>
		</td>			
		<td class="a1" width="15%">序列号</td>
		<td class="a2">
			<ww:textfield name="zzd.serial_nums" id="serial_nums" cssStyle="width:232px" value="%{zzd.serial_nums}" theme="simple" readonly="true" onclick="importSerialNums();"/>
...
<table width="100%"  align="center" id="zzdTable" class="chart_list" cellpadding="0" cellspacing="0">	
	...
	<tr>
		...
		<td class="a2"><ww:textfield name='zzdProducts[%{#li.count-1}].price' id='price_%{#li.count-1}' value="%{getText('global.format.double',{price})}" onblur="hj();" theme="simple" readonly="true" cssStyle="width:90%;text-align:right"/></td>
		<td class="a2"><ww:textfield name='zzdProducts[%{#li.count-1}].nums' id='nums_%{#li.count-1}' value="%{nums}" onblur="hj();" theme="simple" cssStyle="width:90%;text-align:center"/></td>
		<td class="a2"><ww:textfield name='zzdProducts[%{#li.count-1}].hj' id='hj_%{#li.count-1}' value="%{getText('global.format.double',{hj})}" theme="simple" cssStyle="width:90%;text-align:right" readonly="true"/></td>
		<td class="a2">
			<ww:textfield name='zzdProducts[%{#li.count-1}].qz_serial_num' id='qz_serial_num_%{#li.count-1}' value="%{qz_serial_num}" theme="simple" cssStyle="width:80%" readonly="true" onclick="openSerialWin('%{#li.count-1}');"/>
		...
		<td class="a2"><ww:textfield name='zzdProducts[%{#li.count-1}].remark' id='remark_%{#li.count-1}' value="%{remark}" theme="simple" cssStyle="width:90%"/></td>
	</tr>	
	</ww:iterator>
	</ww:if>	
	<ww:else>
	<tr>
		...
		<td class="a2">
			<ww:textfield name='zzdProducts[0].product_name' id='product_name_0' value="" theme="simple" cssStyle="width:90%" readonly="true"/>
			<ww:hidden name='zzdProducts[0].product_id' id='product_id_0' value="" theme="simple"/>
		</td>
		<td class="a2"><ww:textfield name='zzdProducts[0].product_xh' id='product_xh_0' value="" theme="simple" cssStyle="width:90%" readonly="true"/></td>
		<td class="a2"><ww:textfield name='zzdProducts[0].product_dw' id='product_dw_0' value="" theme="simple" cssStyle="width:90%" readonly="true"/></td>
		<td class="a2"><ww:textfield name='zzdProducts[0].price' id='price_0' value="0.00" onblur="hj();" theme="simple" readonly="true" cssStyle="width:90%;text-align:right"/></td>
		<td class="a2"><ww:textfield name='zzdProducts[0].nums' id='nums_0' value="0" onblur="hj();" theme="simple" cssStyle="width:90%;text-align:center"/></td>
		<td class="a2"><ww:textfield name='zzdProducts[0].hj' id='hj_0' value="0.00" theme="simple" cssStyle="width:90%;text-align:right" readonly="true"/></td>
		<td class="a2">
			<ww:textfield name='zzdProducts[0].qz_serial_num' id='qz_serial_num_0' value="" theme="simple" cssStyle="width:80%" readonly="true" onclick="openSerialWin('0');"/>
		...
		<td class="a2"><ww:textfield name='zzdProducts[0].remark' id='remark_0' value="" theme="simple" cssStyle="width:90%"/></td>
	</tr>	
	</ww:else>	
</table>
<table width="100%"  align="center" class="chart_list" cellpadding="0" cellspacing="0">	
	<tr>
		...
		<td class="a2"  width="8%"><input type="text" name="hj_nums" id="hj_nums" value="0" readonly style="width:90%;text-align:center"></td>
		<td class="a2"  width="10%"><input type="text" name="hj_je" id="hj_je" value="0.00" readonly style="width:90%;text-align:right"></td>
		<td class="a2"  width="15%">&nbsp;</td>
