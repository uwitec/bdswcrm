...
<script type="text/javascript">
	...
	function del(id){
		if(confirm("确定要删除该条记录吗！")){
			...
			document.myform.action = "delYufuToYingfu.html?id=" + id;
...
<form name="descForm" action="descYufuToYingfu.html" method="post" target="yufutoyingfudesc">
	<input type="hidden" name="id" value="">
</form>
<table width="100%"  align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td><iframe id="yufutoyingfudesc" name="yufutoyingfudesc" width="100%" onload="dyniframesize('yufutoyingfudesc');" border="0" frameborder="0" SCROLLING="no"  src=''/></td>
	</tr>
</table>
</div>
</body>
