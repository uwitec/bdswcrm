...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0" id="tables">
	...
	<tr>
		...
		<td class="a2" width="35%"><input type="text" name="bxd.id" id="id" value="<%=bxd.getId() %>" readonly></td>	
		 
		<td class="a1">接修时间</td>
		<td class="a2"><input type="text" name="bxd.jxdate" id="jxdate" value="<%=DateComFunc.getToday() %>" readonly>
	...
	<tr>
		...
		<td class="a2">
           ...
           <div  id="brandTip" style=" height:12px; position:absolute;left:150px;top:85px; width:132px;border:1px solid #CCCCCC;background-Color:#fff;display:none;"  ></div>
		   <input type="hidden" name="bxd.jxr" id="fzr" value=""/> 
		</td>	
    	...
    	<td class="a2">	  
         ...
         <img src="images/select.gif" align="absmiddle" title="选择经手人" border="0" onclick="opengcsWin();" style="cursor:hand">
          <div   id="bianTip"  style="height:12px;position:absolute; left:612px; top:85px;  width:132px;border:1px solid #CCCCCC;background-Color:#fff;display:none;" >
		    ...
		    <input type="hidden" name="bxd.gcs" id="gcs"  /> 
		</td>						
	</tr>
	<tr>
...
<table width="100%"  align="center" id="lsdtable"  class="chart_list" cellpadding="0" cellspacing="0">	
	...
	<tr>
		<td class="a2">
			<input type="text" id="product_name" name="bxdProduct.product_name" value="" size="35">
			<input type="hidden" id="product_id" name="bxdProduct.product_id" value="">
			<input type="button" name="selectButton" value="选择" class="css_button" onclick="openWin();">
		</td>
		<td class="a2">
			<input type="text" id="product_gg" name="bxdProduct.product_gg" value=""  >
		</td>
	
		<td class="a2">
			<input type="text" id="product_serial_num" name="bxdProduct.product_serial_num" value="" >
		</td>	
			
		<td class="a2">
		    <input type="text" id="product_remark" name="bxdProduct.product_remark" value="">
		</td>
	</tr>
</table>
<table width="100%"  align="center" class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr height="35">	
		...
		<td class="a1">产品状态</td>
		<td class="a2"  >
			<input type="text" name="bxdProduct.bxstate" id="bxstate" value="" >
		</td>
	</tr>
	...
	<tr >
	   ...
	   <td class="a2" >
	      <input type="checkbox" name="fj" value="硒鼓">   硒鼓&nbsp;&nbsp; 
	      <input type="checkbox" name="fj" value="墨盒">墨盒&nbsp;&nbsp; 
	      <input type="checkbox" name="fj" value="电源线">电源线&nbsp;&nbsp; 
	      <input type="checkbox" name="fj" value="数据线">数据线&nbsp;&nbsp; 
	      <input type="checkbox" name="fj" value="适配器">适配器&nbsp;&nbsp; 
	      <input type="checkbox" name="fj" value="电池">电池&nbsp;&nbsp; 
	       <input type="checkbox" name="fj" value="包">包
	   </td>
	   
	    <td class="a1" width="15%">其他附件</td>
	    <td class="a2">
	    <input type="hidden" name="bxdProduct.has_fj" value=""/>
	    <input type="text" name="bxdProduct.qtfj" id="qtfj" value="" >
	   </td>
	</tr>
	...
	<tr height="35">
		...
		<td class="a2" colspan="3">
			<textarea rows="2" name="bxdProduct.bj" id="bj" style="width:75%"> </textarea>
		</td>	
	</tr>
	...
	<tr height="35">
		...
		<td class="a2" colspan="3">
			<textarea rows="2" name="bxdProduct.gzfx" id="gzfx" style="width:75%"> </textarea>
		</td>	
	</tr>
	...
	<tr>
		...
		<td class="a2" width="85%" colspan="3">
			<textarea  rows="2" name="bxdProduct.pcgc" id="pcgc" style="width:75%"> </textarea>
		</td> 
	</tr>	
</table>
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">	
	...
	<tr>
		...
		<td class="a2">
		<input type="text" name="clientname" onblur="setvalues()" id="client_name"   size="30" maxlength="50" >
		<input type="hidden" name="bxd.client_name" id="client_id"  >
		...
		<td class="a2" width="35%"><input type="text" name="bxd.lxr" id="lxr" size="30" value=" "></td>	
	</tr>
	<tr>
		<td class="a1" width="15%">联系电话</td>
		<td class="a2"><input type="text" name="bxd.lxdh" id="lxdh" value="" size="30" maxlength="20"></td>	
		<td class="a1" width="15%">E-Mail</td>
		<td class="a2"><input type="text" name="bxd.email" id="email" value="" maxlength="50" size="30"></td>			
	</tr>
	<tr>
		<td class="a1" width="15%">地址</td>
		<td class="a2" colspan="3"><input type="text" name="bxd.address" id="address" value=" " size="30" maxlength="100"></td>			
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">	
	...
	<tr>
		...
		<td class="a2" width="85%" colspan="3">
			<textarea rows="2" name="bxd.remark" id="remark" style="width:75%"> </textarea>
		</td>
	</tr>			
	<tr height="35">
