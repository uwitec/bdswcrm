...
<script type="text/javascript">
    ...
    function addTr(){
        ...
        otd0.className = "a2";
        otd0.innerHTML = '<input type="text" id="product_name_'+curId+'" name="bxdProducts['+curId+'].product_name" size="14" style="width:90%" readonly><input type="hidden" id="product_id_'+curId+'" name="bxdProducts['+curId+'].product_id">';
...
<table width="100%"  align="center"  class="chart_info" cellpadding="0" cellspacing="0">
	...
	<tr>		 
		...
		<td class="a2">
		<input type="text" name="bxd.bxcs_id" id="client_name" value="<%=StaticParamDo.getClientNameById(StringUtils.nullToStr(bxd.getBxcs())) %>" size="40" maxlength="60"  onblur="setClientValue();">
...
<%
 ...
 %>
	<tr>
				...
				<td class="a2"><input type="text" id="nums_<%=i %>" name="bxdProducts[<%=i %>].nums" value="<%=bxdProduct.getNums() %>" size="5" onblur="setNum(<%=i %>)"  style="width:90%" readonly></td>		 
				<td class="a2">	
				...
				<td class="a2"><input type="text" id="sxts_<%=i %>" name="bxdProducts[<%=i %>].sxts" value="<%=bxdProduct.getSxts() %>" size="5" onblur="setSxts(<%=i %>)"  style="width:90%"></td>
	...
	for(int i=0;i<3;i++)
	{
		%>
			<tr>
			    <td class="a2"><input type="checkbox" name="proc_id" id="proc_id" value="<%=i %>"></td>
				<td class="a2">
					<input type="text" id="product_name_<%=i %>" name="bxdProducts[<%=i %>].product_name" style="width:90%"  >
					<input type="hidden" id="product_id_<%=i %>" name="bxdProducts[<%=i %>].product_id">
				</td>
				<td class="a2"><input type="text" id="product_xh_<%=i %>" name="bxdProducts[<%=i %>].product_xh" size="13" style="width:90%" ></td>	
				...
				<td class="a2"><input type="text" id="sxts_<%=i %>" name="bxdProducts[<%=i %>].sxts" size="5" onblur="setSxts(<%=i %>)"  style="width:90%"></td>
				<td class="a2"><input type="text" id="cpfj_<%=i %>" name="bxdProducts[<%=i %>].cpfj" size="15"  style="width:90%"></td>				
				<td class="a2"><input type="text" id="product_remark_<%=i %>" name="bxdProducts[<%=i %>].product_remark"  style="width:90%"></td>				
			</tr>
		<%
	}
}
