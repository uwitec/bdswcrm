...
Page results = (Page)VS.findValue("yushouToYingshouPage");
...
<script type="text/javascript">
	...
	function openWin(id){
		var destination = "viewYushouToYingshou.html?id="+id;
	...
	function add(){
		var destination = "addYushouToYingshou.html";
		var fea ='width=800,height=600,left=' + (screen.availWidth-800)/2 + ',top=' + (screen.availHeight-600)/2 + ',directories=no,localtion=no,menubar=no,status=no,toolbar=no,scrollbars=yes,resizeable=no';
	...
	function refreshPage(){
		document.myform.action = "listYushouToYingshou.html";
...
<form name="myform" action="listYushouToYingshou.html" method="post">
<input type="hidden" name="orderType" value="<%=orderType %>">
<input type="hidden" name="orderName" value="<%=orderName %>">
<table width="100%"  align="center"  class="chart_list" cellpadding="0" cellspacing="0">
	<tr>
		<td class="csstitle" align="left" width="75%">&nbsp;&nbsp;&nbsp;&nbsp;<b>预收冲应收</b></td>
...
<table width="100%" align="center"  class="chart_list" cellpadding="0" cellspacing="0" border="1" id="selTable">
	...
	while(it.hasNext()){
		YushouToYingshou info = (YushouToYingshou)it.next();
	%>
...
<form name="descForm" action="descYushouToYingshou.html" method="post" target="yushoutoyingshoudesc">
	<input type="hidden" name="id" value="">
</form>
<table width="100%"  align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td><iframe id="yushoutoyingshoudesc" name="yushoutoyingshoudesc" width="100%" onload="dyniframesize('yushoutoyingshoudesc');" border="0" frameborder="0" SCROLLING="no"  src=''/></td>
	</tr>
</table>
</div>
</body>
