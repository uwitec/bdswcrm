...
<tr><td height='100%'>
	...
	<input type="hidden" ID="Contentback" >
...
<form id="eWebEditor_UploadForm" action="upload.jsp" method="post" target="eWebEditor_UploadTarget"  >
...
<input type="hidden" name="style" value="<%=sStyleName%>">
